...
const RefundPolicy = () => {
    return (
        <div>
            <div className='mb-6'>
                <h2 className='barlow font-semibold text-[32px] leading-[38.4px] mb-4'>Refund Policy (General)</h2>
            ...
            <div >
                <h2 className='barlow font-semibold text-[32px] leading-[38.4px] mb-4'>Refund Policy (Career Consultancy Service)</h2>
